...
public:
    struct cnDate {
        unsigned short lunarYear = 0;
        unsigned char tiangan = 0;
        unsigned char dizhi = 0;
        unsigned char lunarMonth = 0;
        unsigned char lunarDay = 0;
    ...
    cnDate solarToLunar(unsigned short yyyy, unsigned char mm, unsigned char dd);
    unsigned char solarToTerm(unsigned short yyyy, unsigned char mm, unsigned char dd);
    cnLunarDate lunarToChinese(cnDate lunar, unsigned char term);
    char* convertSolarString(unsigned char solar_num);
    char* convertChineseString(uint32_t lunar_mm, uint32_t lunar_dd, bool is_leap_month);

private:
    static const unsigned long BaseData[199] PROGMEM;
    static const unsigned short monthTotal[13] PROGMEM;
    static const unsigned char SolarTerms_List[] PROGMEM;
};
