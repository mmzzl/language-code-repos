...
void getWeather() {
    const String key = "f715d659038b9afa0ba3a9a1d3d0eaa4";
    char* cityCode;
    String cityName;
    String region;
    // 获取地理位置信息
