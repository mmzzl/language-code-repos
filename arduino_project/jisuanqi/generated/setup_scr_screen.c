...
void setup_scr_screen(lv_ui *ui)
{
    ...
    static const char *screen_btnm_1_text_map[] = {"C", "<", "%", "/", "\n", "7", "8", "9", "*", "\n", "4", "5", "6", "-", "\n", "1", "2", "3", "+", "\n", "e", "0", ".", "=", "",};
    lv_btnmatrix_set_map(ui->screen_btnm_1, screen_btnm_1_text_map);
    lv_obj_set_pos(ui->screen_btnm_1, 0, 30);
    lv_obj_set_size(ui->screen_btnm_1, 128, 130);
    ...
    lv_obj_set_pos(ui->screen_label_1, 0, 2);
    lv_obj_set_size(ui->screen_label_1, 128, 26);
