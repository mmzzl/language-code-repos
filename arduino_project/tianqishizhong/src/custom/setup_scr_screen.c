...
void setup_scr_screen(lv_ui *ui)
{
    ...
    lv_obj_set_size(ui->screen_cont_1, 128, 160);
    ...
    lv_obj_set_style_text_font(ui->screen_label_1, &lv_font_STSONG_8, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_2, &lv_font_STSONG_8, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_3, &lv_font_STSONG_8, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_5, &lv_font_STSONG_8, LV_PART_MAIN|LV_STATE_DEFAULT);
    ...
    lv_obj_set_style_text_font(ui->screen_label_7, &lv_font_STSONG_8, LV_PART_MAIN|LV_STATE_DEFAULT);
